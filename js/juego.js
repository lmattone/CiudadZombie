...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 520, 390, 30, 30, 1),
    ...
    new Obstaculo('imagenes/bache.png', 180, 270, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 500, 130, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 290, 480, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 810, 400, 30, 30, 2),
    new Obstaculo('imagenes/auto_verde_abajo.png', 180, 230, 15, 30, 3),
    new Obstaculo('imagenes/auto_verde_abajo.png', 860, 370, 15, 30, 3),
  ...
  enemigos: [
   new ZombieCaminante('imagenes/zombie1.png', 700, 100, 10, 10, 5,{
     desdeX: 0,
     hastaX: 961,
     desdeY: 0,
     hastaY: 577,
   }),
    new ZombieCaminante('imagenes/zombie2.png', 450, 200, 10, 10, 5,{
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577,
    }),
    new ZombieCaminante('imagenes/zombie1.png', 800, 500, 10, 10, 5,{
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577,
    }),
    new ZombieCaminante('imagenes/zombie3.png', 300, 150, 10, 10, 5, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577,
    }),
    new ZombieCaminante('imagenes/zombie4.png', 450, 500, 10, 10, 5, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577,
    ...
    new ZombieConductor('imagenes/tren_vertical.png', 678, 0, 30, 90, 5, {
      desdeX: 0,
      hastaX: 577,
      desdeY: 0,
      hastaY: 961,
...
Juego.calcularAtaques = function() {
  this.enemigos.forEach(function(enemigo) {
    if (this.intersecan(enemigo, this.jugador, this.jugador.x, this.jugador.y)) {
     ...
     //ZombieCaminante.comenzarAtaque(jugador);
     //ZombieConductor.comenzarAtaque(jugador);
    enemigo.comenzarAtaque(this.jugador);
      
    } else {
      /* Sino, debe dejar de atacar
      COMPLETAR */
      //ZombieCaminante.dejarDeAtacar(jugador);
     // ZombieConductor.dejarDeAtacar(jugador);
